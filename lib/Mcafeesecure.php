...
class Mcafeesecure
{
    ...
    public static function scripts($hook){
        if (strpos($hook, "mcafee-secure-settings") !== false) {
            ...
            wp_enqueue_script('mcafeesecure-mcafeesecure-js', plugins_url('../js/trustedsite.js',__FILE__));
        }
    }
    ...
    public static function install()
    {
        ...
        add_shortcode('trustedsite_banner', 'Mcafeesecure::ts_banner_shortcode');
        add_shortcode('trustedsite_testimonial', 'Mcafeesecure::ts_testimonial_shortcode');
